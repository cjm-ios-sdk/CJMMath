 ...
 */
CGFloat CJMGetRadianFromTransform(CGAffineTransform t) {
    double sx = CJMGetScaleXFromTransform(t);
 ...
 * @param t transform 仿射矩阵
 */
CGFloat CJMGetScaleXFromTransform(CGAffineTransform t) {
 ...
 * @param t transform 仿射矩阵
*/
CGFloat CJMGetScaleYFromTransform(CGAffineTransform t) {
 ...
 * @param t transform 仿射矩阵
*/
CGFloat CJMGetTranslateXFromTransform(CGAffineTransform t) {
    return t.tx;
}
 ...
 * @param t transform 仿射矩阵
 */
CGFloat CJMGetTranslateYFromTransform(CGAffineTransform t) {
    return t.ty;
}
 ...
 */
CGRect CJMGetRectByTransformAndRectCenter(CGAffineTransform t, CGRect sourceRect) {
